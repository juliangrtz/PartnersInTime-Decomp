...
extern GameTask *func_ov008_0206ca4c(void *memory, u32 priority, void *argument);
extern GameTask *func_ov008_0206f980(void *memory, u32 priority, void *argument);
extern GameTask *func_ov008_02070e14(void *memory, u32 priority, void *argument);
...
{
    void *memory = GameHeap_New(48, 0, 0, 0);
    if (memory) return func_ov008_0206ca4c(memory, 8, 0);
    return memory;
}
...
{
    void *memory = GameHeap_New(48, 0, 0, 0);
    if (memory) return func_ov008_0206f980(memory, 8, 0);
    return memory;
}
...
{
    void *memory = GameHeap_New(48, 0, 0, 0);
    if (memory) return func_ov008_02070e14(memory, 8, 0);
    return memory;
}
