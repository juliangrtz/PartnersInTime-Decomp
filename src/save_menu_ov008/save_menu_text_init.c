...
SaveMenuText *SaveMenuText_Init(SaveMenuText *context)
{
    ...
    if (!gSaveData[1301]) {
        context->owned_fonts[0] = Overlay5Archive_ReadEntry(*(void **)(data_ov005_0206a180 + 44), 0, 3, 0, 0);
        context->owned_fonts[1] = Overlay5Archive_ReadEntry(*(void **)(data_ov005_0206a180 + 44), 0, 4, 0, 0);
    } else {
        context->owned_fonts[0] = Overlay5Archive_ReadEntry(*(void **)(data_ov005_0206a180 + 44), 0, 8, 0, 0);
        context->owned_fonts[1] = Overlay5Archive_ReadEntry(*(void **)(data_ov005_0206a180 + 44), 0, 4, 0, 0);
    }
