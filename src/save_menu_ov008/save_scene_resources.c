/* Save-menu resources (overlay 8, 0x0206C474-0x0206C670).
 * Compare the stored file with the live party and initialize both panels. */
...
/* Native literal-pool alias of the workspace's second summary. */
extern SaveMenuSummary data_ov008_02078330;
...
void SaveScene_LoadResources(SaveSceneTask *task)
{
    ...
    SaveMenu_BuildLiveSummary(&data_ov008_02078330);
    func_ov008_02071bdc(1, WORK.summaries[1].location);
    SaveMenu_LoadLocationName(1, WORK.summaries[1].location);
