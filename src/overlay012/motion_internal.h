...
void func_ov010_020c20f8(int, int);
void func_ov002_020719e4(BattleSceneObject *, int, int, int);
void func_ov002_0206e7e4(BattleSceneObject *, int, int, int, int, int, int, int, int, int, int);
