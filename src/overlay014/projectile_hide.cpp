...
extern int BattleMotion_StartTransform(BattleSceneObject *, int, int, int, int, int, int, int, int, int, int);
void Overlay14Projectile_BeginHide(Overlay14Projectile *projectile)
{
    func_ov002_0206f0bc(&projectile->object, 0, 31, 0, 8, 0);
    BattleMotion_StartTransform(&projectile->object, 1, 256, 256, 0, 64, 512, 0, 8, 0, 0);
    projectile->phase = 9;
}
