...
void TitleScene_LoadResources(TitleSceneTask *unused)
{
    ...
    resource = func_ov005_020670b4(ARCHIVE, 0, entries.sets[variant].characters, 0, 0);
    Overlay5DisplayBg_LoadCharactersLZ(1, 2, resource, 0);
    if (resource)
        GameHeap_DeleteArray(resource);
    resource = func_ov005_020670b4(ARCHIVE, 0, entries.sets[variant].screen, 0, 0);
    ...
    resource = func_ov005_020670b4(ARCHIVE, 0, entries.sets[variant].palette, 0, 0);
    Overlay5Display_LoadBgPalette(1, resource, 32, 32);
    if (resource)
        GameHeap_DeleteArray(resource);
    resource = func_ov005_020670b4(ARCHIVE, 0, 142, 0, 0);
    Overlay5DisplayBg_LoadCharactersLZ(0, 3, resource, 0);
    if (resource)
        GameHeap_DeleteArray(resource);
    resource = func_ov005_020670b4(ARCHIVE, 0, 143, 0, 0);
    Overlay5DisplayBg_LoadScreenLZ(0, 3, resource, 0);
    if (resource)
        GameHeap_DeleteArray(resource);
    resource = func_ov005_020670b4(ARCHIVE, 0, 144, 0, 0);
    ...
    resource = func_ov005_020670b4(ARCHIVE, 0, 0, 0, 1);
