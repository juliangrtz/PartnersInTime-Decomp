...
FieldAreaContext *FieldArea_CopyState(FieldAreaContext *field, const FieldAreaContext *source)
{
    ...
    field->window_slide.flags.active = source->window_slide.flags.active;
    field->window_slide.flags.fixed_duration = source->window_slide.flags.fixed_duration;
    field->window_slide.flags.window = source->window_slide.flags.window;
    field->window_slide.flags.elapsed = source->window_slide.flags.elapsed;
    field->window_slide.flags.duration = source->window_slide.flags.duration;
    field->window_slide.x = source->window_slide.x;
    field->window_slide.y = source->window_slide.y;
    field->window_slide.previous_x = source->window_slide.previous_x;
    field->window_slide.previous_y = source->window_slide.previous_y;
    field->window_slide.target_x = source->window_slide.target_x;
    field->window_slide.target_y = source->window_slide.target_y;
    field->window_slide.velocity_x = source->window_slide.velocity_x;
    field->window_slide.velocity_y = source->window_slide.velocity_y;
