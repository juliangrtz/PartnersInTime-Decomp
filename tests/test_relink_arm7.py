...
class Arm7LayoutTests(unittest.TestCase):
    ...
    def test_arm7_symbol_map_is_cpu_specific(self) -> None:
        ...
        self.assertEqual(symbols["SND_IsCaptureActive"], 0x037FF104)
        self.assertEqual(symbols["SND_SetupCapture"], 0x037FF11C)
        self.assertEqual(symbols["SNDi_GetExChannelLfoValue"], 0x037FF174)
        self.assertEqual(symbols["SNDi_GetExChannelSweep"], 0x037FF210)
        self.assertEqual(symbols["SNDi_CompareChannelPriority"], 0x037FF280)
        self.assertEqual(symbols["SNDi_StartExChannel"], 0x037FF2E0)
        self.assertEqual(symbols["SNDi_InitExChannel"], 0x037FF32C)
        self.assertEqual(symbols["SNDi_CalcDecay"], 0x037FF3D8)
        self.assertEqual(symbols["SND_GetLfoValue"], 0x037FF438)
        self.assertEqual(symbols["SND_UpdateLfo"], 0x037FF488)
        self.assertEqual(symbols["SND_StartLfo"], 0x037FF4EC)
        self.assertEqual(symbols["SND_InitLfoParam"], 0x037FF4FC)
        self.assertEqual(symbols["SND_InvalidateWave"], 0x037FF520)
        self.assertEqual(symbols["SND_GetLockedChannel"], 0x037FF5A8)
        self.assertEqual(symbols["SND_UnlockChannel"], 0x037FF5C8)
        self.assertEqual(symbols["SND_LockChannel"], 0x037FF604)
        self.assertEqual(symbols["SND_StopUnlockedChannel"], 0x037FF6FC)
        self.assertEqual(symbols["SND_FreeExChannel"], 0x037FF7C4)
        self.assertEqual(symbols["SND_AllocExChannel"], 0x037FF7D8)
        self.assertEqual(symbols["SND_IsExChannelActive"], 0x037FF910)
        self.assertEqual(symbols["SND_UpdateExChannelEnvelope"], 0x037FF990)
        self.assertEqual(symbols["SND_StartExChannelNoise"], 0x037FFA44)
        self.assertEqual(symbols["SND_StartExChannelPsg"], 0x037FFA90)
        self.assertEqual(symbols["SND_StartExChannelPcm"], 0x037FFAE4)
        self.assertEqual(symbols["SND_ExChannelMain"], 0x037FFB20)
        self.assertEqual(symbols["SND_UpdateExChannel"], 0x037FFE2C)
        self.assertEqual(symbols["SND_ExChannelInit"], 0x03800018)
        self.assertEqual(symbols["SNDi_AllocTrack"], 0x03800078)
        self.assertEqual(symbols["SNDi_GetVariablePtr"], 0x038000BC)
        self.assertEqual(symbols["SNDi_PlayerSeqMain"], 0x03800100)
        self.assertEqual(symbols["SNDi_TrackSeqMain"], 0x03800180)
        self.assertEqual(symbols["SNDi_NoteOnCommandProc"], 0x03800B34)
        self.assertEqual(symbols["SNDi_UpdatePlayerChannel"], 0x03800D40)
        self.assertEqual(symbols["SNDi_UpdateTrackChannel"], 0x03800D84)
        self.assertEqual(symbols["SNDi_ChannelCallback"], 0x03800EC4)
        self.assertEqual(symbols["SNDi_FinishPlayer"], 0x03800F2C)
        self.assertEqual(symbols["SNDi_ClosePlayerTrack"], 0x03800F6C)
        self.assertEqual(symbols["SNDi_CloseTrack"], 0x03800FC0)
        self.assertEqual(symbols["SNDi_GetPlayerTrack"], 0x03800FE0)
        self.assertEqual(symbols["SNDi_PlayerTempoMain"], 0x0380100C)
        self.assertEqual(symbols["SNDi_FreeTrackChannelAll"], 0x038010CC)
        self.assertEqual(symbols["SNDi_ReleaseTrackChannelAll"], 0x03801108)
        self.assertEqual(symbols["SNDi_InitPlayer"], 0x03801178)
        self.assertEqual(symbols["SNDi_StartTrack"], 0x03801228)
        self.assertEqual(symbols["SNDi_InitTrack"], 0x0380123C)
        self.assertEqual(symbols["SNDi_ReadArg"], 0x03801330)
        self.assertEqual(symbols["SNDi_ReadVar"], 0x038013F8)
        self.assertEqual(symbols["SNDi_Read24"], 0x03801438)
        self.assertEqual(symbols["SNDi_Read16"], 0x03801498)
        self.assertEqual(symbols["SNDi_GetByteCache"], 0x038014E8)
        self.assertEqual(symbols["SNDi_InitCache"], 0x03801538)
        self.assertEqual(symbols["SNDi_SetTrackParam"], 0x03801574)
        self.assertEqual(symbols["SNDi_SetPlayerParam"], 0x03801618)
        self.assertEqual(symbols["SND_InvalidateBank"], 0x03801664)
        self.assertEqual(symbols["SND_InvalidateSeq"], 0x038016C4)
        self.assertEqual(symbols["SND_SetTrackAllocatableChannel"], 0x03801760)
        self.assertEqual(symbols["SND_SetTrackMute"], 0x038017D8)
        self.assertEqual(symbols["SND_SkipSeq"], 0x03801874)
        self.assertEqual(symbols["SND_PauseSeq"], 0x03801940)
        self.assertEqual(symbols["SND_StopSeq"], 0x038019C4)
        self.assertEqual(symbols["SND_StartSeq"], 0x03801A20)
        self.assertEqual(symbols["SND_StartPreparedSeq"], 0x03801A3C)
        self.assertEqual(symbols["SND_PrepareSeq"], 0x03801A5C)
        self.assertEqual(symbols["SND_SeqMain"], 0x03801BB0)
        self.assertEqual(symbols["SND_SeqInit"], 0x03801C50)
        self.assertEqual(symbols["SNDi_GetWaveData"], 0x03801CBC)
        self.assertEqual(symbols["SND_NoteOn"], 0x03801CFC)
        self.assertEqual(symbols["SND_GetWaveDataAddress"], 0x03801E24)
        self.assertEqual(symbols["SND_ReadInstData"], 0x03801E6C)
        self.assertEqual(symbols["SND_UpdateSharedWork"], 0x03801FF0)
        self.assertEqual(symbols["SND_SetPlayerGlobalVariable"], 0x03802090)
        self.assertEqual(symbols["SND_SetPlayerLocalVariable"], 0x038020AC)
        self.assertEqual(symbols["SNDi_AlarmHandler"], 0x038020CC)
        self.assertEqual(symbols["SND_StopAlarm"], 0x038020FC)
        self.assertEqual(symbols["SND_StartAlarm"], 0x0380213C)
        self.assertEqual(symbols["SND_SetupAlarm"], 0x03802204)
        self.assertEqual(symbols["SND_AlarmInit"], 0x03802260)
        self.assertEqual(symbols["SNDi_ReadDriverInfo"], 0x0380228C)
        self.assertEqual(symbols["SNDi_StopTimer"], 0x038022F8)
        self.assertEqual(symbols["SNDi_StartTimer"], 0x038023BC)
        self.assertEqual(symbols["SNDi_SetChannelPan"], 0x038024B0)
        self.assertEqual(symbols["SNDi_SetChannelVolume"], 0x038024F8)
        self.assertEqual(symbols["SNDi_SetChannelTimer"], 0x03802550)
        ...
        self.assertEqual(symbols["CARDi_ReadRomID"], 0x03803614)
        self.assertEqual(symbols["CARDi_ReadRom"], 0x0380367C)
        self.assertEqual(symbols["CARDi_ReadRomIDCore"], 0x038036F4)
        self.assertEqual(symbols["CARDi_ReadCard"], 0x03803758)
        self.assertEqual(symbols["CARDi_SetRomOp"], 0x03803850)
        self.assertEqual(symbols["CARDi_ReadEnd"], 0x038038F0)
        self.assertEqual(symbols["CARDi_ReadFromCache"], 0x0380396C)
        ...
        self.assertEqual(symbols["CARDi_EraseBackupSectorCore"], 0x03802E58)
        self.assertEqual(symbols["CARDi_VerifyBackupCore"], 0x03802EA8)
        self.assertEqual(symbols["CARDi_WriteBackupCore"], 0x03802F48)
        self.assertEqual(symbols["CARDi_ProgramBackupCore"], 0x03803018)
        self.assertEqual(symbols["CARDi_ReadBackupCore"], 0x038030E8)
        self.assertEqual(symbols["CARDi_SendSpiAddressingCommand"], 0x03803150)
        self.assertEqual(symbols["CARDi_WriteEnable"], 0x038031FC)
        self.assertEqual(symbols["CARDi_CommVerifyCore"], 0x03803240)
        self.assertEqual(symbols["CARDi_CommWriteCore"], 0x038032A8)
        self.assertEqual(symbols["CARDi_CommReadCore"], 0x038032F4)
        self.assertEqual(symbols["CARDi_CommArray"], 0x03803338)
        ...
        self.assertEqual(symbols["sLockedChannelMask"], 0x03808264)
        self.assertEqual(symbols["sWeakLockedChannelMask"], 0x03808268)
        self.assertEqual(symbols["SNDi_SharedWork"], 0x03808288)
        self.assertEqual(symbols["SNDi_Work"], 0x0380828C)
        self.assertEqual(symbols["SNDi_SeqCacheState"], 0x03808270)
        self.assertEqual(symbols["SNDi_SeqCacheData"], 0x03808278)
        self.assertEqual(symbols["SNDi_PlayerPool"], 0x038087CC)
        self.assertEqual(symbols["SNDi_TrackPool"], 0x03808A0C)
        self.assertEqual(symbols["SNDi_VolumeShiftTable"], 0x0380747C)
