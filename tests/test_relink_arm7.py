...
class Arm7LayoutTests(unittest.TestCase):
    ...
    def test_arm7_symbol_map_is_cpu_specific(self) -> None:
        ...
        self.assertEqual(symbols["SVC_SoftReset"], 0x03803D90)
        self.assertEqual(symbols["SVC_Halt"], 0x03803DAE)
        self.assertEqual(symbols["SVC_WaitByLoop"], 0x03803D94)
        self.assertEqual(symbols["SVC_WaitIntr"], 0x03803D98)
        ...
        self.assertEqual(symbols["SPI_Init"], 0x03804244)
        ...
        self.assertEqual(symbols["CARD_CheckPullOut_Polling"], 0x03803B48)
        self.assertEqual(symbols["CARD_IsPulledOut"], 0x03803CB4)
        self.assertEqual(symbols["CARDi_PulledOutCallback"], 0x03803D04)
        self.assertEqual(symbols["CARDi_ReadFromCache"], 0x0380396C)
        self.assertEqual(symbols["CARDi_TaskEraseSector"], 0x03803A04)
        self.assertEqual(symbols["CARDi_TaskReadRomID"], 0x03803AA8)
        self.assertEqual(symbols["CARDi_TaskUnsupported"], 0x03803AD0)
