...
not identical register allocation. The 23,492-byte field dispatcher is nearly
usable as port code today — it compiles and covers all 290 slots — while it
correctly remains unlinked for the ROM build at 66.35% fuzzy similarity. The
