...
248 independent units. Those units cover raw
...
images. There are 30,838 currently known relocations. `BattleActor_GetPartySlot`
at `0x02076F44` and
...
ARMv4T assembly or symbolic module parameters. One hundred and five maintained units
...
through SPI/RCNT. They include 1,258 verified autoload relocations; ARM7 now has 1,277 verified
