...
185 independent units. Those units cover raw
...
images. There are 29,859 currently known relocations. `BattleActor_GetPartySlot`
at `0x02076F44` and
...
ARMv4T assembly or symbolic module parameters. Thirty-six maintained units
...
dispatch, scheduler suppression, alarm-backed sleep, thread bootstrap and switch-callback
...
initializer, and two Thumb SVC wrappers. They include 279 verified autoload
relocations; ARM7 now has 298 verified
