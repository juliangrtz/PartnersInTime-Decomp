...
255 independent units. Those units cover raw
...
images. There are 30,987 currently known relocations. `BattleActor_GetPartySlot`
at `0x02076F44` and
...
ARMv4T assembly or symbolic module parameters. One hundred and twelve maintained units
...
include 1,407 verified autoload relocations; ARM7 now has 1,426 verified
