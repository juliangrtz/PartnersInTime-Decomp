...
234 independent units. Those units cover raw
...
images. There are 30,605 currently known relocations. `BattleActor_GetPartySlot`
at `0x02076F44` and
...
ARMv4T assembly or symbolic module parameters. Eighty-nine maintained units
...
ROM-ID/data request setup, page reads, cache-backed unaligned transfers, and
ARM9-command-to-ARM7-operation dispatch,
...
initializer, and two Thumb SVC wrappers. They include 1,025 verified autoload
relocations; ARM7 now has 1,044 verified
