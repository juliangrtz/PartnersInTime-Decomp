...
239 independent units. Those units cover raw
...
images. There are 30,669 currently known relocations. `BattleActor_GetPartySlot`
at `0x02076F44` and
...
ARMv4T assembly or symbolic module parameters. Ninety-six maintained units
...
PXI/worker dispatch, and the common SPI request ring and exception lock. They
include 1,089 verified autoload relocations; ARM7 now has 1,108 verified
