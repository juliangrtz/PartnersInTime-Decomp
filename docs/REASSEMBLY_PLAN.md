...
181 independent units. Those units cover raw
...
images. There are 29,767 currently known relocations. `BattleActor_GetPartySlot`
at `0x02076F44` and
...
ARMv4T assembly or symbolic module parameters. Twenty-eight maintained units
...
and lock setup, PXI FIFO initialization and public send/callback APIs, the timer-0 tick subsystem, alarm
initialization, the Game Pak initializer, and two Thumb SVC wrappers. They
include 187 verified autoload relocations; ARM7 now has 206 verified
