...
193 independent units. Those units cover raw
...
images. There are 30,065 currently known relocations. `BattleActor_GetPartySlot`
at `0x02076F44` and
...
ARMv4T assembly or symbolic module parameters. Forty-nine maintained units
...
sampling, sound output/sleep/shutdown control, CPSR interrupt
...
initializer, and two Thumb SVC wrappers. They include 485 verified autoload
relocations; ARM7 now has 504 verified
