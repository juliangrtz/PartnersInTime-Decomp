...
images. There are 30,025 currently known relocations. `BattleActor_GetPartySlot`
at `0x02076F44` and
...
ARMv4T assembly or symbolic module parameters. Forty-five maintained units
...
allocator, V-count alarms, CPSR interrupt
...
initializer, and two Thumb SVC wrappers. They include 445 verified autoload
relocations; ARM7 now has 464 verified
