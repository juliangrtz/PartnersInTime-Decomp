...
184 independent units. Those units cover raw
...
images. There are 29,851 currently known relocations. `BattleActor_GetPartySlot`
at `0x02076F44` and
...
ARMv4T assembly or symbolic module parameters. Thirty-five maintained units
...
dispatch, scheduler suppression, thread bootstrap and switch-callback
...
initializer, and two Thumb SVC wrappers. They include 271 verified autoload
relocations; ARM7 now has 290 verified
