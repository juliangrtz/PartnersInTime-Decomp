...
249 independent units. Those units cover raw
...
images. There are 30,860 currently known relocations. `BattleActor_GetPartySlot`
at `0x02076F44` and
...
ARMv4T assembly or symbolic module parameters. One hundred and six maintained units
...
register, and LED requests. They include 1,280 verified autoload relocations;
ARM7 now has 1,299 verified
