...
230 independent units. Those units cover raw
...
images. There are 30,553 currently known relocations. `BattleActor_GetPartySlot`
at `0x02076F44` and
...
ARMv4T assembly or symbolic module parameters. Eighty-five maintained units
...
read, write, and program operations, their bytewise SPI transfer engine, and
VCOUNT-bounded command completion,
...
initializer, and two Thumb SVC wrappers. They include 973 verified autoload
relocations; ARM7 now has 992 verified
