...
241 independent units. Those units cover raw
...
images. There are 30,719 currently known relocations. `BattleActor_GetPartySlot`
at `0x02076F44` and
...
ARMv4T assembly or symbolic module parameters. Ninety-eight maintained units
...
lock, and complete SPI service/thread initialization. They include 1,139
verified autoload relocations; ARM7 now has 1,158 verified
