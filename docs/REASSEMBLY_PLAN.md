...
246 independent units. Those units cover raw
...
images. There are 30,808 currently known relocations. `BattleActor_GetPartySlot`
at `0x02076F44` and
...
ARMv4T assembly or symbolic module parameters. One hundred and three maintained units
...
sample/status encoding. They include 1,228 verified autoload relocations; ARM7
now has 1,247 verified
