...
191 independent units. Those units cover raw
...
images. There are 30,029 currently known relocations. `BattleActor_GetPartySlot`
at `0x02076F44` and
...
ARMv4T assembly or symbolic module parameters. Forty-seven maintained units
...
allocator, V-count alarms, DMA waiting, CPU memory primitives, CPSR interrupt
...
initializer, and two Thumb SVC wrappers. They include 449 verified autoload
relocations; ARM7 now has 468 verified
