...
231 independent units. Those units cover raw
...
images. There are 30,559 currently known relocations. `BattleActor_GetPartySlot`
at `0x02076F44` and
...
ARMv4T assembly or symbolic module parameters. Eighty-six maintained units
...
VCOUNT-bounded command completion, and ARM7 CARD ROM-service initialization,
...
initializer, and two Thumb SVC wrappers. They include 979 verified autoload
relocations; ARM7 now has 998 verified
