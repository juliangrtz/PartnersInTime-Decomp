...
247 independent units. Those units cover raw
...
images. There are 30,816 currently known relocations. `BattleActor_GetPartySlot`
at `0x02076F44` and
...
ARMv4T assembly or symbolic module parameters. One hundred and four maintained units
...
sample/status encoding and five-sample channel filtering. They include 1,236
verified autoload relocations; ARM7 now has 1,255 verified
