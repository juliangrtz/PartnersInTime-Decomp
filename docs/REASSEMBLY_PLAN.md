...
222 independent units. Those units cover raw
...
images. There are 30,440 currently known relocations. `BattleActor_GetPartySlot`
at `0x02076F44` and
...
ARMv4T assembly or symbolic module parameters. Seventy-seven maintained units
...
sound-command opcodes, ARM7 file-system/CARD-back-end initialization, and CARD
...
initializer, and two Thumb SVC wrappers. They include 618 verified autoload
relocations; ARM7 now has 637 verified
