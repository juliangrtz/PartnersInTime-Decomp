...
206 independent units. Those units cover raw
...
images. There are 30,214 currently known relocations. `BattleActor_GetPartySlot`
at `0x02076F44` and
...
ARMv4T assembly or symbolic module parameters. Sixty-two maintained units
...
voice priority/initialization, sequence-track allocation/player dispatch,
