...
images. There are 29,926 currently known relocations. `BattleActor_GetPartySlot`
at `0x02076F44` and
...
ARMv4T assembly or symbolic module parameters. Forty-two maintained units
...
state, thread-list/ID/context primitives, message queues, CPSR interrupt
...
initializer, and two Thumb SVC wrappers. They include 346 verified autoload
relocations; ARM7 now has 365 verified
