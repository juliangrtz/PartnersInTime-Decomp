...
183 independent units. Those units cover raw
...
images. There are 29,845 currently known relocations. `BattleActor_GetPartySlot`
at `0x02076F44` and
...
ARMv4T assembly or symbolic module parameters. Thirty-four maintained units
...
dispatch, thread bootstrap and switch-callback
...
initializer, and two Thumb SVC wrappers. They include 265 verified autoload
relocations; ARM7 now has 284 verified
