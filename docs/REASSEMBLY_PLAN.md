...
images. There are 29,828 currently known relocations. `BattleActor_GetPartySlot`
at `0x02076F44` and
...
ARMv4T assembly or symbolic module parameters. Thirty-three maintained units
...
initializer, and two Thumb SVC wrappers. They include 248 verified autoload
relocations; ARM7 now has 267 verified
