...
194 independent units. Those units cover raw
...
images. There are 30,096 currently known relocations. `BattleActor_GetPartySlot`
at `0x02076F44` and
...
ARMv4T assembly or symbolic module parameters. Fifty maintained units
...
sampling, sound output/sleep/shutdown and channel control, CPSR interrupt
...
initializer, and two Thumb SVC wrappers. They include 516 verified autoload
relocations; ARM7 now has 535 verified
