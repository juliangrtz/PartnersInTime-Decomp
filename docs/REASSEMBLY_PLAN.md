...
253 independent units. Those units cover raw
...
images. There are 30,931 currently known relocations. `BattleActor_GetPartySlot`
at `0x02076F44` and
...
ARMv4T assembly or symbolic module parameters. One hundred and ten maintained units
...
state switching. They include 1,351 verified autoload relocations; ARM7 now
has 1,370 verified
