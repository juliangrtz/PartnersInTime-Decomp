...
164 independent units. Those units cover raw
...
images. There are 29,668 currently known relocations. `BattleActor_GetPartySlot`
at `0x02076F44` and
...
ARMv4T assembly or symbolic module parameters. Sixteen maintained units from
...
state, CPSR interrupt control, reset coordination, and two Thumb SVC wrappers.
They include 88 verified autoload relocations; ARM7 now has 107 verified
