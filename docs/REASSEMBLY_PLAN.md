...
236 independent units. Those units cover raw
...
images. There are 30,640 currently known relocations. `BattleActor_GetPartySlot`
at `0x02076F44` and
...
ARMv4T assembly or symbolic module parameters. Ninety-three maintained units
...
initializer, and all 25 Thumb SVC wrappers. They include 1,060 verified autoload
relocations; ARM7 now has 1,079 verified
