...
images. There are 29,905 currently known relocations. `BattleActor_GetPartySlot`
at `0x02076F44` and
...
ARMv4T assembly or symbolic module parameters. Forty maintained units
...
initializer, and two Thumb SVC wrappers. They include 325 verified autoload
relocations; ARM7 now has 344 verified
