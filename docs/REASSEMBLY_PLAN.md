...
265 independent units. Those units cover raw
...
overlay 2. All resident ARM7 bytes are maintained
...
2. Continue promoting small overlay-2 battle leaf functions using the four
