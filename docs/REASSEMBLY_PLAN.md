...
237 independent units. Those units cover raw
...
images. There are 30,643 currently known relocations. `BattleActor_GetPartySlot`
at `0x02076F44` and
...
ARMv4T assembly or symbolic module parameters. Ninety-four maintained units
...
initializer, all 25 Thumb SVC wrappers, and the population-count helper. They
include 1,063 verified autoload relocations; ARM7 now has 1,082 verified
