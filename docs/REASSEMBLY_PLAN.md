...
254 independent units. Those units cover raw
...
images. There are 30,973 currently known relocations. `BattleActor_GetPartySlot`
at `0x02076F44` and
...
ARMv4T assembly or symbolic module parameters. One hundred and eleven maintained units
...
restoration. They include 1,393 verified autoload relocations; ARM7 now has
1,412 verified
