...
176 independent units. Those units cover raw
...
images. There are 29,736 currently known relocations. `BattleActor_GetPartySlot`
at `0x02076F44` and
...
ARMv4T assembly or symbolic module parameters. Twenty-four maintained units
...
setup, PXI FIFO initialization, the timer-0 tick subsystem, alarm
initialization, and two Thumb SVC wrappers. They include 144 verified autoload
relocations; ARM7 now has 175 verified
