...
197 independent units. Those units cover raw
...
images. There are 30,148 currently known relocations. `BattleActor_GetPartySlot`
at `0x02076F44` and
...
ARMv4T assembly or symbolic module parameters. Fifty-three maintained units
...
thread/message/timer/startup path, CPSR interrupt
...
initializer, and two Thumb SVC wrappers. They include 568 verified autoload
relocations; ARM7 now has 587 verified
