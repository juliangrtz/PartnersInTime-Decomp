...
192 independent units. Those units cover raw
...
images. There are 30,044 currently known relocations. `BattleActor_GetPartySlot`
at `0x02076F44` and
...
ARMv4T assembly or symbolic module parameters. Forty-eight maintained units
...
initializer, and two Thumb SVC wrappers. They include 464 verified autoload
relocations; ARM7 now has 483 verified
