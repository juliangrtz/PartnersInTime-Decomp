...
238 independent units. Those units cover raw
...
images. There are 30,653 currently known relocations. `BattleActor_GetPartySlot`
at `0x02076F44` and
...
ARMv4T assembly or symbolic module parameters. Ninety-five maintained units
...
initializer, all 25 Thumb SVC wrappers, the population-count helper, and SPI
PXI/worker dispatch. They include 1,073 verified autoload relocations; ARM7 now
has 1,092 verified
