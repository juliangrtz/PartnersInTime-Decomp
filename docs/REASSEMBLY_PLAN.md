...
201 independent units. Those units cover raw
...
images. There are 30,165 currently known relocations. `BattleActor_GetPartySlot`
at `0x02076F44` and
...
ARMv4T assembly or symbolic module parameters. Fifty-six maintained units
...
initializer, and two Thumb SVC wrappers. They include 585 verified autoload
relocations; ARM7 now has 604 verified
