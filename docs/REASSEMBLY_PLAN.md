...
168 independent units. Those units cover raw
...
images. There are 29,709 currently known relocations. `BattleActor_GetPartySlot`
at `0x02076F44` and
...
ARMv4T assembly or symbolic module parameters. Nineteen maintained units from
...
the timer-0 tick subsystem, and two Thumb SVC wrappers. They include 129
verified autoload relocations; ARM7 now has 148 verified
