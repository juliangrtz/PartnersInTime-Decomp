...
166 independent units. Those units cover raw
...
images. There are 29,687 currently known relocations. `BattleActor_GetPartySlot`
at `0x02076F44` and
...
ARMv4T assembly or symbolic module parameters. Eighteen maintained units from
...
and two Thumb SVC wrappers. They include 107 verified autoload relocations;
ARM7 now has 126 verified
