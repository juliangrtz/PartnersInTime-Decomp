...
189 independent units. Those units cover raw
...
images. There are 29,910 currently known relocations. `BattleActor_GetPartySlot`
at `0x02076F44` and
...
ARMv4T assembly or symbolic module parameters. Forty-one maintained units
...
state, thread-list/ID/context primitives, CPSR interrupt control, reset coordination, IRQ-table, arena, lock-ID,
...
initializer, and two Thumb SVC wrappers. They include 330 verified autoload
relocations; ARM7 now has 349 verified
