...
212 independent units. Those units cover raw
...
images. There are 30,311 currently known relocations. `BattleActor_GetPartySlot`
at `0x02076F44` and
...
ARMv4T assembly or symbolic module parameters. Sixty-seven maintained units
...
decoding, playback controls, and sequence preparation, wave invalidation,
channel locking,
