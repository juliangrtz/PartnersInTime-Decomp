...
228 independent units. Those units cover raw
...
images. There are 30,511 currently known relocations. `BattleActor_GetPartySlot`
at `0x02076F44` and
...
ARMv4T assembly or symbolic module parameters. Eighty-three maintained units
...
read, write, and program operations,
...
initializer, and two Thumb SVC wrappers. They include 931 verified autoload
relocations; ARM7 now has 950 verified
