...
256 independent units. Those units cover raw
...
images. There are 31,000 currently known relocations. `BattleActor_GetPartySlot`
at `0x02076F44` and
...
ARMv4T assembly or symbolic module parameters. One hundred and thirteen maintained units
...
cross-autoload `WMSP_Init` call. There are 1,420 verified autoload relocations;
ARM7 now has 1,439 verified
