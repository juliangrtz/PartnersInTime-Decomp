...
195 independent units. Those units cover raw
...
images. There are 30,105 currently known relocations. `BattleActor_GetPartySlot`
at `0x02076F44` and
...
ARMv4T assembly or symbolic module parameters. Fifty-one maintained units
...
sampling, sound output/sleep/shutdown, channel control and utilities, CPSR interrupt
...
initializer, and two Thumb SVC wrappers. They include 525 verified autoload
relocations; ARM7 now has 544 verified
