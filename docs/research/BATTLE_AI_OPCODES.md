...
| `0x3C` | `0x02079E5C` | — | — | `BattleObjectData_ResetAll` |
...
| `0x65` | `0x0207B5BC` | — | — | `BattleVm_StartMotionWithPeakDistance` |
| `0x66` | `0x0207B5D4` | — | — | `BattleVm_StartScaledAcceleratedMotion` |
| `0x67` | `0x0207B5EC` | — | — | `BattleVm_StartBallisticMotion` |
...
| `0x77` | `0x0207BC98` | — | — | — |
| `0x78` | `0x0207BCA8` | — | `0x8`, `0xC` | `BattleEnemy_Remove` |
| `0x79` | `0x0207BCD4` | — | — | — |
| `0x7A` | `0x0207BCE4` | — | — | — |
| `0x7B` | `0x0207BCF4` | — | — | — |
| `0x7C` | `0x0207BD04` | — | — | — |
...
| `0x7F` | `0x0207BF44` | — | — | `BattleActor_IsAnyHitLocked` |
...
| `0x9E` | `0x0207CC94` | — | `0x8` | — |
| `0x9F` | `0x0207CD14` | — | `0x8` | `BattleScriptHandle_IsActive` |
| `0xA0` | `0x0207CD7C` | — | `0x8` | `BattleScriptHandle_IsActive`, `VM_WriteVariable` |
| `0xA1` | `0x0207CDB0` | — | `0x8`, `0xC`, `0x10`, `0x14`, `0x18`, `0x1C`, `0x20`, `0x24`, `0x28`, `0x2C`, `0x30`, `0x34`, `0x38`, `0x3C` | `BattleSceneObject_StretchBetweenAnchors` |
...
| `0xCA` | `0x0207D748` | — | — | — |
| `0xCB` | `0x0207D898` | — | `0x8`, `0xC` | `BattleAI_UpdateControlMask` |
| `0xCC` | `0x0207D8FC` | — | `0x8`, `0xC` | `BattleAI_UpdateControlMask` |
| `0xCD` | `0x0207D928` | — | `0x8` | — |
| `0xCE` | `0x0207D94C` | — | `0x8` | — |
| `0xCF` | `0x0207D970` | — | — | — |
| `0xD0` | `0x0207D980` | — | — | — |
...
| `0xDF` | `0x0207E11C` | — | `0x8`, `0xC`, `0x10` | `BattleActor_IsHitLocked` |
| `0xE0` | `0x0207E15C` | — | — | — |
