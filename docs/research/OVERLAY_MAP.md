...
| [8](../../src/overlay008/) | Save, load, erase and game-over menus | 22,148 / 54,068 | 40.96% | Scene setup and cleanup, models, text, location previews, scrolling, save-state transfer, save writing, its brightness/zoom effects and erase confirmation. |
