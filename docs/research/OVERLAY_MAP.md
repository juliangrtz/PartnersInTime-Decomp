...
| [7](../../src/overlay007/) | Scene VM, pause menu and jump-rope minigame | 57,064 / 142,264 | 40.11% | Scene dispatcher and object management; menu text, equipment, party HP/level bitmaps, cursors, backgrounds, effects, rope physics, minigame level-menu rendering and script launch/return, follower animation and rope sprites on both screens. |
