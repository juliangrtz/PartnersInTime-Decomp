...
| 17 | 16,784 B | Battle attack sequence with threshold-driven tuning tables | `0x020C2C94-0x020C2E54` (8 functions, 448 B) | Pair/group tuning lookup block reconstructed; exact item identity remains open |
