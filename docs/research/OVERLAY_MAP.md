...
|---:|---|---:|---:|---|
| [0](../../src/field/) | Field and world | 182,344 / 366,712 | 49.72% | Field VM; entity movement, collision and rendering; party actions, locomotion categories and partner-state updates, direction-speed selection, auxiliary animation transitions, trail visibility and stopping, follower-offset calculation, member bindings, follower state binding, height gates and slope distance scaling, default actions, leader palette animation, entity palette-profile switching and queued music, room resource/request allocation, camera and background layer motion, room transitions, effect animations, screen wipes, HUD and message windows. |
