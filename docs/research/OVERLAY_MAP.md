...
| [2](../../src/battle/) | Battle engine | 163,120 / 362,436 | 45.01% | Both battle VM dispatchers; damage and Stache-based hit-bonus rolls, status, targeting, rewards, UI, models, effects and object-relative effect spawning, resource loading, scheduler and IRQ-task lifecycle, queues, VBlank transfer processing and node-list operations, and battle transitions. |
