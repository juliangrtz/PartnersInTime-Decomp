...
| 17 | 16,784 B | Battle attack sequence with threshold-driven tuning tables, a four-object party/support setup, and display initialization | `0x020C2C94-0x020C30D0`, `0x020C3280-0x020C33A4` (15 functions, 1,376 B) | Tuning lookup, party resource swap/readiness, object setup, animation completion, and display startup reconstructed; exact item identity remains open |
