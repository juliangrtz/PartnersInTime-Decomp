...
| [7](../../src/overlay007/) | Scene VM, pause menu and jump-rope minigame | 59,528 / 142,264 | 41.84% | Scene dispatcher and object management; menu text, equipment, party HP/level bitmaps, numeric display creation/interpolation and play-time formatting, clock separator, cursors, backgrounds and blend-background setup, sprite position and lifetime updates, list-row text/marker/quantity sprites, effects, rope physics, minigame level-menu rendering and script launch/return, follower animation and rope sprites on both screens. |
