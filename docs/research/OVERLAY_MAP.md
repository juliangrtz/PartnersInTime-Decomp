...
| [8](../../src/overlay008/) | Save, load, erase and game-over menus | 22,760 / 54,068 | 42.09% | Scene setup and cleanup, models, text, location previews, scrolling, save-state transfer, save writing, effect setup and brightness/zoom updates, failure rollback setup, save-menu exit and erase confirmation. |
