...
| 17 | 16,784 B | Battle attack sequence with threshold-driven tuning tables, a four-object party/support setup, and display initialization | `0x020C2C94-0x020C30D0`, `0x020C3280-0x020C3570` (17 functions, 1,836 B) | Tuning lookup, party resource swap/readiness, object setup, display startup, object-state polling, and model/resource animation configuration reconstructed; exact item identity remains open |
