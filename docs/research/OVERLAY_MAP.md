...
| 17 | 16,784 B | Battle attack sequence with threshold-driven tuning tables and a four-object party/support setup | `0x020C2C94-0x020C30D0` (11 functions, 1,084 B) | Tuning lookup, party resource swap/readiness, object setup, and animation completion reconstructed; exact item identity remains open |
