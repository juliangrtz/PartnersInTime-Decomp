...
|---:|---|---:|---:|---|
| [0](../../src/field/) | Field and world | 179,040 / 366,712 | 48.82% | Field VM; entity movement, collision and rendering; party actions, member bindings, default actions, leader palette animation and queued music, room resource/request allocation, camera and background layer motion, room transitions, effect animations, screen wipes, HUD and message windows. |
