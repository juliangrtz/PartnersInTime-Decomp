...
| [7](../../src/overlay007/) | Scene VM, pause menu and jump-rope minigame | 58,416 / 142,264 | 41.06% | Scene dispatcher and object management; menu text, equipment, party HP/level bitmaps, numeric display creation/interpolation and play-time formatting, clock separator, cursors, backgrounds, effects, rope physics, minigame level-menu rendering and script launch/return, follower animation and rope sprites on both screens. |
