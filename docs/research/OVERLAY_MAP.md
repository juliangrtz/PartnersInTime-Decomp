...
|---:|---|---:|---:|---|
| [0](../../src/field/) | Field and world | 176,756 / 366,712 | 48.20% | Field VM; entity movement, collision and rendering; party actions, camera and background layer motion, room transitions, effect animations, screen wipes, HUD and message windows. |
