...
| [2](../../src/battle/) | Battle engine | 161,968 / 362,436 | 44.69% | Both battle VM dispatchers; damage and Stache-based hit-bonus rolls, status, targeting, rewards, UI, models, effects and object-relative effect spawning, resource loading, scheduler queues and node-list operations, and battle transitions. |
