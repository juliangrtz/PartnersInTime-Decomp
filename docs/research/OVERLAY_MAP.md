...
| 16 | 18,324 B | Battle attack code with a 20-entry motion table, resource-backed 20-byte motion records, and attack-object state/motion gates | `0x020C2AE0-0x020C2BBC` (4 functions, 220 B) | Active quick-win target; continue through adjacent object-state helpers while retaining neutral attack naming |
