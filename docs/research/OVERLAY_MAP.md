...
| [9](../../src/overlay009/) | Shops | 23,380 / 78,984 | 29.60% | Stock and inventory access, coin/bean buying prices and affordability, discounts, quantities, new-item markers, item/buying/inventory-panel construction and destruction, buying-panel show/hide controls, queued item/stock text updates, icon lookup, singular/plural names and description indices, equipment/count queries, list navigation, top-level menu cursor and option drawing, deferred menu-task removal, resources, graphics transfers and particles. |
