...
| [7](../../src/overlay007/) | Scene VM, pause menu and jump-rope minigame | 58,676 / 142,264 | 41.24% | Scene dispatcher and object management; menu text, equipment, party HP/level bitmaps, numeric display creation/interpolation and play-time formatting, clock separator, cursors, backgrounds and blend-background setup, effects, rope physics, minigame level-menu rendering and script launch/return, follower animation and rope sprites on both screens. |
