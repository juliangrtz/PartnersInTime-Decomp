...
| [7](../../src/overlay007/) | Scene VM, pause menu and jump-rope minigame | 57,228 / 142,264 | 40.23% | Scene dispatcher and object management; menu text, equipment, party HP/level bitmaps, clock separator, cursors, backgrounds, effects, rope physics, minigame level-menu rendering and script launch/return, follower animation and rope sprites on both screens. |
