...
| [17](../../src/attack_copy_flower_ov017/) | Copy Flowers | 5,296 / 16,784 | 31.55% | Tuning tables, target cycling, participant input and idle-slot search, entry/return and exit arcs, home positions, animation, effect objects, display setup and model cleanup. |
| [18](../../src/attack_pocket_chomp_ov018/) | Pocket Chomps | 10,204 / 18,036 | 56.58% | Adult input windows, support attack/swing updates and Chomp speed boosts; attack entry, repeated rounds, Chomp phases and cleanup; tuning tables, Chomp entry/exit, animation, support attachment and attacks, anchor offsets and tether setup. |
