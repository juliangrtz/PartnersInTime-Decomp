...
| [6](../../src/overlay006/) | Title screen and credits | 26,220 / 66,492 | 39.43% | Scene and interrupt setup, resources, title panels, split-screen transitions, backgrounds, sprite sequences, localized animation, texture/model drawing, brightness fades and credits motion. |
