...
| [7](../../src/overlay007/) | Scene VM, pause menu and jump-rope minigame | 60,116 / 142,264 | 42.26% | Scene dispatcher and object management; menu text, equipment, party HP/level bitmaps, numeric display creation/interpolation and play-time formatting, clock separator, cursors, backgrounds and blend-background setup, sprite position and lifetime updates, list-row text/marker/quantity sprites, list show/hide and row-width measurement, effects, rope physics, minigame level-menu rendering and script launch/return, follower animation and rope sprites on both screens. |
