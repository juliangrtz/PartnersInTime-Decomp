...
the source and link metadata on 2026-09-10.
...
| [6](../../src/overlay006/) | Title screen and credits | 21,972 / 66,492 | 33.04% | Scene and interrupt setup, resources, title panels, sprite sequences, localized animation, texture drawing and credits motion. |
