...
| [8](../../src/overlay008/) | Save, load, erase and game-over menus | 23,772 / 54,068 | 43.97% | Scene setup and cleanup, models, text and panel preparation, location previews, scrolling, save-state transfer, save writing, effect setup and brightness/zoom updates, failure rollback setup, save-menu entry, selection and exit, and erase confirmation. |
