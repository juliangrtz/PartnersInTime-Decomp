...
|---:|---|---:|---:|---|
| [0](../../src/field/) | Field and world | 178,440 / 366,712 | 48.66% | Field VM; entity movement, collision and rendering; party actions, member bindings, default actions, leader palette animation and queued music, camera and background layer motion, room transitions, effect animations, screen wipes, HUD and message windows. |
