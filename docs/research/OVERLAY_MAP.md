...
| [2](../../src/battle/) | Battle engine | 162,392 / 362,436 | 44.81% | Both battle VM dispatchers; damage and Stache-based hit-bonus rolls, status, targeting, rewards, UI, models, effects and object-relative effect spawning, resource loading, scheduler queues, VBlank transfer processing and node-list operations, and battle transitions. |
