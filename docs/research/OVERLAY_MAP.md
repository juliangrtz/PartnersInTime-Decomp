...
| [14](../../src/attack_bro_flower_ov014/) | Bro Flowers and Ice Flowers | 8,872 / 13,860 | 64.01% | Attack sequencing, target selection, participant input/animation phases, projectile selection, flight/bounce/return phases and effects, throws, projectile levels, participant palette pulses and fade control, and enemy-effect allocation and cleanup. |
