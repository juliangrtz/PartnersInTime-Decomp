...
| 18 | 18,036 B | Battle attack code with ten-row progress thresholds for input windows, alternate-actor probability, launch height, duration, distance, speed, and Q8 motion scaling | `0x020C30F0-0x020C3298` (9 functions, 424 B) | Active quick-win target; the tuning-table access layer is reconstructed, while the exact Bros. item identity remains open |
