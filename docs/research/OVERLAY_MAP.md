...
| 8 | 54,068 B | Save/menu scene family: resident field result 5 enters `func_ov008_0206ca4c`; the scene snapshots party stats, inventory, options, and the scripted save-location byte, and its confirmation path invokes the resident save writer | None | Save-menu role proven; name and isolate its three scene controllers before reconstructing leaf helpers |
