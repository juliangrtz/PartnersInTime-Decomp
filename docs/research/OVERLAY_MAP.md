...
| [14](../../src/attack_bro_flower_ov014/) | Bro Flowers and Ice Flowers | 7,784 / 13,860 | 56.16% | Attack sequencing, target selection, participant input/animation phases, projectile selection and initial effects, throws, projectile levels, fades and enemy-effect allocation and cleanup. |
