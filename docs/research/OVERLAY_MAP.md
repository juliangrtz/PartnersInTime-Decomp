...
| [7](../../src/overlay007/) | Scene VM, pause menu and jump-rope minigame | 56,312 / 142,264 | 39.58% | Scene dispatcher and object management; menu text, equipment, cursors, backgrounds, effects, rope physics, minigame level-menu rendering and script launch/return, follower animation and rope sprites on both screens. |
...
| [9](../../src/overlay009/) | Shops | 28,692 / 78,984 | 36.33% | Stock and inventory access, coin/bean buying prices and affordability, discounts, quantities, new-item markers, item/buying/inventory-panel construction and destruction, buying-panel show/hide controls, panel opening/closing animation and close-task creation, quantity digits, total-price drawing, selected-icon copies and quantity-name updates, quantity-panel sprite and availability-arrow drawing, price-adjustment value/marker drawing and mode control, queued item/stock text updates, icon lookup, singular/plural names and description indices, equipment/count queries, list navigation, list-scale animation and point-model drawing, top-level menu cursor and option drawing, display initialization and currency drawing, help-text rendering and background setup, party labels, bitmap values and placeholder dashes, OBJ placeholder drawing, glyph expansion, deferred menu-task removal, resources, graphics transfers and particles. |
