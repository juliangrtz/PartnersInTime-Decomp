...
| [14](../../src/attack_bro_flower_ov014/) | Bro Flowers and Ice Flowers | 9,616 / 13,860 | 69.38% | Attack sequencing, target selection, participant input/animation phases, projectile selection, flight/bounce/return phases and effects, throws, projectile levels, participant palette pulses and fade control, enemy effect-stage thresholds and placement, and effect allocation and cleanup. |
