...
| [18](../../src/attack_pocket_chomp_ov018/) | Pocket Chomps | 10,004 / 18,036 | 55.47% | Adult input windows and support attack/swing updates; attack entry, repeated rounds, Chomp phases and cleanup; tuning tables, Chomp entry/exit, animation, support attachment and attacks, anchor offsets and tether setup. |
