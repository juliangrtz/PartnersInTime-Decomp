...
| [9](../../src/overlay009/) | Shops | 24,952 / 78,984 | 31.59% | Stock and inventory access, coin/bean buying prices and affordability, discounts, quantities, new-item markers, item/buying/inventory-panel construction and destruction, buying-panel show/hide controls, queued item/stock text updates, icon lookup, singular/plural names and description indices, equipment/count queries, list navigation, list-scale animation and point-model drawing, top-level menu cursor and option drawing, help-text rendering and background setup, party labels, bitmap values and placeholder dashes, OBJ placeholder drawing, glyph expansion, deferred menu-task removal, resources, graphics transfers and particles. |
