...
| [9](../../src/overlay009/) | Shops | 22,092 / 78,984 | 27.97% | Stock and inventory access, coin/bean buying prices and affordability, discounts, quantities, new-item markers, item/buying/inventory-panel construction and destruction, buying-panel show/hide controls, queued item/stock text updates and icon lookup, equipment/count queries, list navigation, resources, graphics transfers and particles. |
