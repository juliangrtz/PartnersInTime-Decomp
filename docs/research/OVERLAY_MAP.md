...
| [18](../../src/attack_pocket_chomp_ov018/) | Pocket Chomps | 8,180 / 18,036 | 45.35% | Attack entry, repeated rounds, Chomp phase updates and cleanup; tuning tables, Chomp entry/exit, animation, support attachment and attacks, anchor offsets and tether setup. |
