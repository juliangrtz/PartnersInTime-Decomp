...
scans are now reintegrated. The current MWCC build is one 19,180-byte function
with no compiler-generated helper symbols. It is 75.50% fuzzy-similar to the
