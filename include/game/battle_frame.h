...
typedef struct BattleFrameContextView {
    ...
    BattleSceneObject *scene_table[56];
    BattlePartyActorStorage party_storage[4];
    BattlePartyActor *party[4];
    BattleEnemyActor enemy_storage[8];
    BattleActor *enemies[8];
