/* Restore Luigi and Baby Luigi after the linked knockout resource transition. */

.syntax unified
.arch armv5te
.arm
.section .pit_BattleParty_UpdateLuigiReloadFinish, "ax", %progbits
.balign 4
...
.global BattleParty_UpdateLuigiReloadFinish
.type BattleParty_UpdateLuigiReloadFinish, %function
BattleParty_UpdateLuigiReloadFinish:
    push {r4, r5, lr}
    sub sp, sp, #4
...
.L_always_chance:
    .word 0x7FFF
.size BattleParty_UpdateLuigiReloadFinish, . - BattleParty_UpdateLuigiReloadFinish
