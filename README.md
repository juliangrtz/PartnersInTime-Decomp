...
- Every ARM9 and ARM7 runtime image now relinks as 43 components and 245
...
The verified pass covers 43 components, 245 section units, 109 maintained
units, and 30,789 currently known relocations with zero differing bytes. To
...
still conservatively marked as mixed code/data images; 102 proven autoload-0
units are maintained source and 1,209 autoload relocations are mapped, but
