...
- Every ARM9 and ARM7 runtime image now relinks as 43 components and 409
  independent, fixed-address ELF units.
- One hundred and twenty named overlay-2 battle functions are maintained symbolic ARM source,
...
The verified pass covers 43 components, 409 section units, 244 maintained
