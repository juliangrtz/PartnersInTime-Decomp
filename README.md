...
- Every ARM9 and ARM7 runtime image now relinks as 43 components and 239
...
The verified pass covers 43 components, 239 section units, 103 maintained
units, and 30,669 currently known relocations with zero differing bytes. To
...
still conservatively marked as mixed code/data images; 96 proven autoload-0
units are maintained source and 1,089 autoload relocations are mapped, but
