...
- Every ARM9 and ARM7 runtime image now relinks as 43 components and 362
  independent, fixed-address ELF units.
- Eighty-four named overlay-2 battle functions are maintained symbolic ARM source,
...
The verified pass covers 43 components, 362 section units, 208 maintained
