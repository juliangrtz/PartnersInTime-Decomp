...
- Every ARM9 and ARM7 runtime image now relinks as 43 components and 178
...
- ARM7 autoload 0 now has exact symbolic sources for `ARM7_Main` and the
  ...
  maintained. Lock initialization, PXI FIFO initialization, the hardware-timer
  tick subsystem, alarm initialization, and the public Game Pak initializer are
  symbolic too.
...
The verified pass covers 43 components, 178 section units, 32 maintained
units, and 29,744 currently known relocations with zero differing bytes. To
...
still conservatively marked as mixed code/data images; 25 proven autoload-0
units are maintained source and 164 autoload relocations are mapped, but
