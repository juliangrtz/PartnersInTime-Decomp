...
- ARM7 autoload 0 now has exact symbolic sources for `ARM7_Main` and the
  ...
  symbolic as well, including current-thread resource release and exit.
...
The verified pass covers 43 components, 188 section units, 46 maintained
units, and 29,896 currently known relocations with zero differing bytes. To
...
still conservatively marked as mixed code/data images; 39 proven autoload-0
units are maintained source and 316 autoload relocations are mapped, but
