...
- Every ARM9 and ARM7 runtime image now relinks as 43 components and 257
...
The verified pass covers 43 components, 257 section units, 121 maintained
units, and 31,014 currently known relocations with zero differing bytes. To
...
still conservatively marked as mixed code/data images; 114 proven autoload-0
units are maintained source and 1,434 autoload relocations are mapped, but
