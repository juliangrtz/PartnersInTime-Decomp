...
- Every ARM9 and ARM7 runtime image now relinks as 43 components and 392
  independent, fixed-address ELF units.
- One hundred and nine named overlay-2 battle functions are maintained symbolic ARM source,
...
The verified pass covers 43 components, 392 section units, 233 maintained
