...
- Every ARM9 and ARM7 runtime image now relinks as 43 components and 249
...
The verified pass covers 43 components, 249 section units, 113 maintained
units, and 30,860 currently known relocations with zero differing bytes. To
...
still conservatively marked as mixed code/data images; 106 proven autoload-0
units are maintained source and 1,280 autoload relocations are mapped, but
