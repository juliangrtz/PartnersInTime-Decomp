...
- Every ARM9 and ARM7 runtime image now relinks as 43 components and 248
...
The verified pass covers 43 components, 248 section units, 112 maintained
units, and 30,838 currently known relocations with zero differing bytes. To
...
still conservatively marked as mixed code/data images; 105 proven autoload-0
units are maintained source and 1,258 autoload relocations are mapped, but
