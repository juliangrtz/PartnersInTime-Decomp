...
- Every ARM9 and ARM7 runtime image now relinks as 43 components and 258
...
The verified pass covers 43 components, 258 section units, 122 maintained
units, and 31,057 currently known relocations with zero differing bytes. To
...
still conservatively marked as mixed code/data images; 115 proven autoload-0
units are maintained source and 1,477 autoload relocations are mapped, but
