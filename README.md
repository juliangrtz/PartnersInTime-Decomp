...
- Every ARM9 and ARM7 runtime image now relinks as 43 components and 260
...
The verified pass covers 43 components, 260 section units, 124 maintained
units, and 31,113 currently known relocations with zero differing bytes. To
...
still conservatively marked as mixed code/data images; 117 proven autoload-0
units are maintained source and 1,533 autoload relocations are mapped, but
