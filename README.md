...
- Every ARM9 and ARM7 runtime image now relinks as 43 components and 259
...
The verified pass covers 43 components, 259 section units, 123 maintained
units, and 31,089 currently known relocations with zero differing bytes. To
...
still conservatively marked as mixed code/data images; 116 proven autoload-0
units are maintained source and 1,509 autoload relocations are mapped, but
