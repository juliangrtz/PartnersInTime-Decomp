...
- Every ARM9 and ARM7 runtime image now relinks as 43 components and 304
  independent, fixed-address ELF units.
- Thirty-one named overlay-2 battle functions are maintained symbolic ARM source,
...
The verified pass covers 43 components, 304 section units, 155 maintained
