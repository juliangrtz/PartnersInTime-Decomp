...
- Every ARM9 and ARM7 runtime image now relinks as 43 components and 250
...
The verified pass covers 43 components, 250 section units, 114 maintained
units, and 30,880 currently known relocations with zero differing bytes. To
...
still conservatively marked as mixed code/data images; 107 proven autoload-0
units are maintained source and 1,300 autoload relocations are mapped, but
