...
- Every ARM9 and ARM7 runtime image now relinks as 43 components and 287
  independent, fixed-address ELF units.
- Seventeen named overlay-2 battle functions are maintained symbolic ARM source,
  ...
  formulas, HP/KO updates, status removal/reset, healing, revival, cures, stat
  items, and equipped healing-badge boosts. Every function matches its original
  bytes.
...
The verified pass covers 43 components, 287 section units, 141 maintained
