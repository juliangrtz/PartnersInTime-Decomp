...
- Every ARM9 and ARM7 runtime image now relinks as 43 components and 321
  independent, fixed-address ELF units.
- Fifty named overlay-2 battle functions are maintained symbolic ARM source,
...
The verified pass covers 43 components, 321 section units, 174 maintained
