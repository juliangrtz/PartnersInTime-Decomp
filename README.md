...
- Every ARM9 and ARM7 runtime image now relinks as 43 components and 251
...
The verified pass covers 43 components, 251 section units, 115 maintained
units, and 30,889 currently known relocations with zero differing bytes. To
...
still conservatively marked as mixed code/data images; 108 proven autoload-0
units are maintained source and 1,309 autoload relocations are mapped, but
