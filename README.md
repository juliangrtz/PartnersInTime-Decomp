...
- Every ARM9 and ARM7 runtime image now relinks as 43 components and 246
...
The verified pass covers 43 components, 246 section units, 110 maintained
units, and 30,808 currently known relocations with zero differing bytes. To
...
still conservatively marked as mixed code/data images; 103 proven autoload-0
units are maintained source and 1,228 autoload relocations are mapped, but
