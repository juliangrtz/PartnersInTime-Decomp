...
- Every ARM9 and ARM7 runtime image now relinks as 43 components and 247
...
The verified pass covers 43 components, 247 section units, 111 maintained
units, and 30,816 currently known relocations with zero differing bytes. To
...
still conservatively marked as mixed code/data images; 104 proven autoload-0
units are maintained source and 1,236 autoload relocations are mapped, but
