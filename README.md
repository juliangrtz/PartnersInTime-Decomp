...
- Every ARM9 and ARM7 runtime image now relinks as 43 components and 255
...
The verified pass covers 43 components, 255 section units, 119 maintained
units, and 30,987 currently known relocations with zero differing bytes. To
...
still conservatively marked as mixed code/data images; 112 proven autoload-0
units are maintained source and 1,407 autoload relocations are mapped, but
