...
- Every ARM9 and ARM7 runtime image now relinks as 43 components and 242
...
The verified pass covers 43 components, 242 section units, 106 maintained
units, and 30,750 currently known relocations with zero differing bytes. To
...
still conservatively marked as mixed code/data images; 99 proven autoload-0
units are maintained source and 1,170 autoload relocations are mapped, but
