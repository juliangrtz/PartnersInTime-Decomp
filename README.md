...
- Every ARM9 and ARM7 runtime image now relinks as 43 components and 236
...
The verified pass covers 43 components, 236 section units, 100 maintained
units, and 30,640 currently known relocations with zero differing bytes. To
...
still conservatively marked as mixed code/data images; 93 proven autoload-0
units are maintained source and 1,060 autoload relocations are mapped, but
