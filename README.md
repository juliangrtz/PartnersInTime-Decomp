...
- Every ARM9 and ARM7 runtime image now relinks as 43 components and 384
  independent, fixed-address ELF units.
- One hundred and three named overlay-2 battle functions are maintained symbolic ARM source,
...
The verified pass covers 43 components, 384 section units, 227 maintained
