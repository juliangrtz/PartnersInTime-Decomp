...
- Every ARM9 and ARM7 runtime image now relinks as 43 components and 253
...
The verified pass covers 43 components, 253 section units, 117 maintained
units, and 30,931 currently known relocations with zero differing bytes. To
...
still conservatively marked as mixed code/data images; 110 proven autoload-0
units are maintained source and 1,351 autoload relocations are mapped, but
