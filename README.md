...
- Every ARM9 and ARM7 runtime image now relinks as 43 components and 302
  independent, fixed-address ELF units.
- Thirty named overlay-2 battle functions are maintained symbolic ARM source,
...
The verified pass covers 43 components, 302 section units, 154 maintained
