...
- Every ARM9 and ARM7 runtime image now relinks as 43 components and 168
...
- ARM7 autoload 0 now has exact symbolic sources for `ARM7_Main` and the
  ...
  maintained. The complete hardware-timer tick subsystem is symbolic too.
...
The verified pass covers 43 components, 168 section units, 26 maintained
units, and 29,709 currently known relocations with zero differing bytes. To
...
still conservatively marked as mixed code/data images; 19 proven autoload-0
units are maintained source and 129 autoload relocations are mapped, but
