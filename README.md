...
- Every ARM9 and ARM7 runtime image now relinks as 43 components and 193
...
The verified pass covers 43 components, 193 section units, 56 maintained
units, and 30,065 currently known relocations with zero differing bytes. To
...
still conservatively marked as mixed code/data images; 49 proven autoload-0
units are maintained source and 485 autoload relocations are mapped, but
