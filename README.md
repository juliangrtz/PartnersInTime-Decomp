...
- Every ARM9 and ARM7 runtime image now relinks as 43 components and 337
  independent, fixed-address ELF units.
- Sixty-four named overlay-2 battle functions are maintained symbolic ARM source,
...
The verified pass covers 43 components, 337 section units, 188 maintained
