...
- Every ARM9 and ARM7 runtime image now relinks as 43 components and 252
...
The verified pass covers 43 components, 252 section units, 116 maintained
units, and 30,905 currently known relocations with zero differing bytes. To
...
still conservatively marked as mixed code/data images; 109 proven autoload-0
units are maintained source and 1,325 autoload relocations are mapped, but
