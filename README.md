...
- Every ARM9 and ARM7 runtime image now relinks as 43 components and 314
  independent, fixed-address ELF units.
- Forty-two named overlay-2 battle functions are maintained symbolic ARM source,
...
The verified pass covers 43 components, 314 section units, 166 maintained
