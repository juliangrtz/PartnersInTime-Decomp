...
- Every ARM9 and ARM7 runtime image now relinks as 43 components and 243
...
The verified pass covers 43 components, 243 section units, 107 maintained
units, and 30,758 currently known relocations with zero differing bytes. To
...
still conservatively marked as mixed code/data images; 100 proven autoload-0
units are maintained source and 1,178 autoload relocations are mapped, but
