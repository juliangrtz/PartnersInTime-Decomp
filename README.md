...
- Every ARM9 and ARM7 runtime image now relinks as 43 components and 244
...
The verified pass covers 43 components, 244 section units, 108 maintained
units, and 30,773 currently known relocations with zero differing bytes. To
...
still conservatively marked as mixed code/data images; 101 proven autoload-0
units are maintained source and 1,193 autoload relocations are mapped, but
