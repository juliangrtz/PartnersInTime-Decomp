...
- Every ARM9 and ARM7 runtime image now relinks as 43 components and 313
  independent, fixed-address ELF units.
- Forty named overlay-2 battle functions are maintained symbolic ARM source,
...
The verified pass covers 43 components, 313 section units, 164 maintained
