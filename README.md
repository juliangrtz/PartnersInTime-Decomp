...
- Every ARM9 and ARM7 runtime image now relinks as 43 components and 256
...
The verified pass covers 43 components, 256 section units, 120 maintained
units, and 31,000 currently known relocations with zero differing bytes. To
...
still conservatively marked as mixed code/data images; 113 proven autoload-0
units are maintained source and 1,420 autoload relocations are mapped, but
