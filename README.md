...
- Every ARM9 and ARM7 runtime image now relinks as 43 components and 254
...
The verified pass covers 43 components, 254 section units, 118 maintained
units, and 30,973 currently known relocations with zero differing bytes. To
...
still conservatively marked as mixed code/data images; 111 proven autoload-0
units are maintained source and 1,393 autoload relocations are mapped, but
