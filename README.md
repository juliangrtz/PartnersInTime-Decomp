...
- Every ARM9 and ARM7 runtime image now relinks as 43 components and 361
  independent, fixed-address ELF units.
- Eighty-one named overlay-2 battle functions are maintained symbolic ARM source,
...
The verified pass covers 43 components, 361 section units, 205 maintained
